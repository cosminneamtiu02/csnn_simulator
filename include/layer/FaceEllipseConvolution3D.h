#ifndef _FACE_ELLIPSE_CONVOLTUION3D_H
#define _FACE_ELLIPSE_CONVOLTUION3D_H
...
namespace layer
{
	 ...
	 */
	class FaceEllipseConvolution3D;

	namespace _priv
	{

#ifdef SMID_AVX256
		class FaceEllipseConvolution3DImpl
		{

		public:
			FaceEllipseConvolution3DImpl(FaceEllipseConvolution3D &model);
		...
		private:
			FaceEllipseConvolution3D &_model;
	 ...
	 */
	class FaceEllipseConvolution3D : public Layer4D
	{

		friend class _priv::FaceEllipseConvolution3DImpl;

	public:
		/**
		 * @brief Construct a new FaceEllipseConvolution3D object
		 *
		 */
		FaceEllipseConvolution3D();

		/**
		 * @brief Construct a new FaceEllipseConvolution3D object, this one allows passing a trained mdoel weights by giving the exp name.
		 *
		 */
